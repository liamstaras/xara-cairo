...
String_128::String_128(const TCHAR* psz)
{
	*(text = fixedbuf) = 0;
...
/**************************************************************************************
>	String_128::String_128( PCSTR psz )
...
/**************************************************************************************
>	String_128::String_128(const StringBase& other)
...
void String_128::CopyConstruct( const StringBase &other )
{
	*(text = fixedbuf) = 0;
	length = FIX_LEN_BUFSIZE;
...
/**************************************************************************************
>	String_128::String_128(UINT32 resID, UINT32 hinst = 0)
...
String_128::String_128(UINT32 resID, UINT32 hinst)
{
	*(text = fixedbuf) = 0;
	length = FIX_LEN_BUFSIZE;
	if (!Load(resID, hinst))
...
/**************************************************************************************
>	virtual BOOL String_128::Alloc(INT32 nSize)
...
BOOL String_128::Alloc(INT32 nSize)
{
