...
BOOL OpURLImport::Init()
{
	return RegisterOpDescriptor(
									...
									0,							// help ID GTODO: Is this needed?
...
>	BOOL OpURLImport::ImportURL(WebAddress urlToGet)
  ...
  GTODO: Handle local files
  GTODO: HMOve this function somewhere useful
...
Filter* OpURLImport::GetAllFilter()
{
	...
	ERROR2IF(pFilterManager==NULL, FALSE, "OpURLImport::ImportURL - FilterManager does not exist");

	return pFilterManager->FindFilterFromID(FILTERID_GENERIC);
